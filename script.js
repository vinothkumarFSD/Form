...
function inputele(tagname, attrname, attrvalue, attrname1, attrvalue2, attrname2, attrvalue3) {
    var ele = document.createElement(tagname);
    ele.setAttribute(attrname, attrvalue);
    ele.setAttribute(attrname1, attrvalue2);
    ele.setAttribute(attrname2, attrvalue3);
    return ele;
}
...
function getData() {
    ...
    if (count == 1) {
        alert("must choose minimum two items");
        return false;
    }
